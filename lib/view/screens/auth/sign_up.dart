                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        GestureDetector(
                         onTap: (){
                           authenticationController.pickImage();
                         },
                          child: Container(
                            ...
                            child: authenticationController.pickedImage.value.path.isEmpty? FlutterLogo(
                              size: 70.r,
                            ):Image.file(
                                fit: BoxFit.cover,
                                File(authenticationController.pickedImage.value.path)),
                          ),
                        ),
                      ],
                    ),
                    ...
                    CustomTextField(
                      textEditingController:
                          authenticationController.firstNameController.value,
                      validator: (value) {
                    ...
                    CustomTextField(
                      textEditingController:
                      authenticationController.lastNameController.value,
                      validator: (value) {
                        if (value == null || value.toString().isEmpty) {
                          return AppStaticStrings.fieldCantBeEmpty;
                        } else if (value.length < 4) {
                    ...
                    CustomTextField(
                      textEditingController:
                      authenticationController.addressController.value,
                      validator: (value) {
                        if (value == null || value.toString().isEmpty) {
                          return AppStaticStrings.fieldCantBeEmpty;
                        } else if (value.length < 4) {
